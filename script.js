...
function reset() {
    ...
    buttonPause[0].removeEventListener("click", pause);
...
function timerCountdown () {
    if(checkLoop == 0) {
        ...
        document.title = "Pomodoro (" + countdownValue[0].innerHTML + ")";
    } else if (checkLoop == 2) {
    ...
    if(timeLeft == 0) {
        ...
        if(checkLoop == 1 || checkLoop == 3 || checkLoop == 5) {
            ...
            a = 1;
            TimeCounterArray[a] = SelectorsValueArray[a] * 60
            document.title = "Short Pause (" + countdownValue[0].innerHTML + ")";
        }else if(checkLoop == 0 || checkLoop == 2 || checkLoop == 4 || checkLoop == 6) {
            audioShort.play();
            a = 0;
            TimeCounterArray[a] = SelectorsValueArray[a] * 60
            document.title = "Pomodoro (" + countdownValue[0].innerHTML + ")";
            ...
            a = 2;
            TimeCounterArray[a] = SelectorsValueArray[a] * 60;
            document.title = "Long Pause(" + countdownValue[0].innerHTML + ")";
        }else if(checkLoop == 8) {
            audioShort.play();
            document.getElementsByClassName("pomodoro2")[0].src = "pomodoro_pixeloso_bw.png"
            document.getElementsByClassName("pomodoro3")[0].src = "pomodoro_pixeloso_bw.png"
